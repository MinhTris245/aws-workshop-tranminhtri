...
The following video demonstrates the workflow and key features of the Document Security system.

<div style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 960px;">
  <iframe src="https://www.youtube.com/embed/qGceRJa0M9w" title="Document Security system demo video" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: 0;" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</div>
