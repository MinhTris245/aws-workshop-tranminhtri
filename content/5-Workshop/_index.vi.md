...
Video dưới đây trình bày quá trình vận hành và các chức năng chính của hệ thống Document Security.

<div style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 960px;">
  <iframe src="https://www.youtube.com/embed/qGceRJa0M9w" title="Video demo hệ thống Document Security" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: 0;" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</div>
